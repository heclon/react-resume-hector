...
import Lornajane from './Lornajane';
import FantasticFurniture from './FantasticFurniture';
            ...
            <Grid container className={classes.gridHorizontal}>
              <Grid item xs={12} sm={6}>
                ...
                <Typography
                  ...
                  className={classes.description}
                >
                  Built with Java on SAP Hybris ecommerce
                </Typography>
            ...
            <Grid container className={classes.gridHorizontal}>
              <Grid item xs={12} sm={6}>
                <Typography variant="h6" className={classes.subtitle}>
                  <DoneAllIcon /> Black Scholes Options Pricing - American &
                  European
                  <Typography
                    variant="h6"
                    color="textSecondary"
              ...
              <Grid item xs={12} sm={6}>
                <Typography variant="h6" className={classes.subtitle}>
                  <DoneAllIcon /> Barrier Options using Sequential Monte Carlo -
                  European
                  <Typography
                    variant="h6"
                    color="textSecondary"
